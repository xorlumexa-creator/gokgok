...
export const countries: Country[] = [
  {
    ...
    currency: 'BDT', currencySymbol: '৳', basicPrice: 80, standardPrice: 140, proPrice: 200, paymentMethods: ['bkash'],
  },
  {
    code: 'IN', name: 'India', nameLocal: 'ভারত', dialCode: '+91', flag: '🇮🇳',
    currency: 'INR', currencySymbol: '₹', basicPrice: 80, standardPrice: 140, proPrice: 200, paymentMethods: ['card'],
  },
  {
    code: 'PK', name: 'Pakistan', nameLocal: 'পাকিস্তান', dialCode: '+92', flag: '🇵🇰',
    currency: 'PKR', currencySymbol: '₨', basicPrice: 80, standardPrice: 140, proPrice: 200, paymentMethods: ['card'],
  },
  {
    code: 'US', name: 'United States', nameLocal: 'যুক্তরাষ্ট্র', dialCode: '+1', flag: '🇺🇸',
    currency: 'USD', currencySymbol: '$', basicPrice: 1, standardPrice: 2, proPrice: 3, paymentMethods: ['card'],
  },
  {
