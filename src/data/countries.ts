...
export const countries: Country[] = [
  {
    ...
    currency: 'BDT', currencySymbol: '৳', proPrice: 80, premiumPrice: 150, paymentMethods: ['bkash'],
  },
  {
    code: 'IN', name: 'India', nameLocal: 'ভারত', dialCode: '+91', flag: '🇮🇳',
    currency: 'INR', currencySymbol: '₹', proPrice: 80, premiumPrice: 150, paymentMethods: ['card'],
  },
  {
    code: 'PK', name: 'Pakistan', nameLocal: 'পাকিস্তান', dialCode: '+92', flag: '🇵🇰',
    currency: 'PKR', currencySymbol: '₨', proPrice: 80, premiumPrice: 150, paymentMethods: ['card'],
  },
  {
    code: 'US', name: 'United States', nameLocal: 'যুক্তরাষ্ট্র', dialCode: '+1', flag: '🇺🇸',
    currency: 'USD', currencySymbol: '$', proPrice: 1, premiumPrice: 2, paymentMethods: ['card'],
  },
  {
